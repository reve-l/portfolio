...
export default function Coonectez({open,phonenumber,handleClose,data,onChange,onChangelist,onChangephone,handleLogin,handleRegister,errorconnect,regist,handleRegisterShowHide,passforget,handlePAssForget,smspassforget,smshidepassforget,hidepassforget, errors,passshow,HandlePassShow,HandleGender}) {
            ...
            <div className='wrapper'>
                ...
                {regist?
                     ...
                     <div className='rigth2'>
                         <form className='mb-5' onSubmit={()=>handleRegister(data)}>
                         <h5>Inscription dans le site <img src={revel} alt="revel" className="img-fluid img-conx"/></h5>
                             {errorconnect && <span className='errorconect'>{errorconnect}</span>}
                        ...
                        <span className='conect-regist' onClick={handleRegisterShowHide}>
                ...
                <>
                      ...
                      <div className='rigth'>
                              ...
                              <form className='mb-5'>
                                  {errorconnect && <span className='errorconect'>{errorconnect}</span>}
                                  <h6 className='connx-s-title'>Formulaire de connexion:</h6>
                                  {
                                      passforget?
                                ...
                                <Button color="primary" variant="contained" onClick={()=>handleLogin(data)} autoFocus size="small">
                                  {regist?"S'inscrire":"Connexionssss"}
                                </Button>
